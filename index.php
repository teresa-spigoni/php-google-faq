      ...
      <header class="w-100">
        <div class="top flex">
          ...
          <div>
            ...
            <div class="avatar">
              <img src="img/avatar.png" alt="" class="w-100">
            </div>
          </div>
        </div>
        <div class="bottom">
      ...
      <main class="w-100">
        ...
        <div class="main-container">
          ...
          foreach ($faqs as $key => $value) {
            ...
            <h2 class="question"><?php echo $value["Q"] ?></h2>
            <p class="answer"><?php echo $value["A"] ?></p>
